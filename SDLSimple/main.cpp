...
// ––––– STRUCTS AND ENUMS ––––– //
//enum EntityType{ PLAYER, PLATFORM, TRAP, ENEMY };
...
constexpr char SPRITESHEET_FILEPATH[] = "sprites/george_0.png";
...
constexpr char BGM_FILEPATH[] = "sprites/crypto.mp3",
...
void initialise()
{
    ...
    g_state.platforms[random_int].set_entity_type(TRAP);
